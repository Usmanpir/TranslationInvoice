    ...
    mounted && open && coords
      ? createPortal(
          <div
            ...
            className="fixed z-[70] w-[300px] bg-card rounded-2xl shadow-elevated border border-slate-200/70 p-3 animate-scale-in"
            onKeyDown={onKeyNav}
          >
  ...
  return (
    <>
      <button
        ...
        className={cn(
          'relative w-full h-10 pl-9 pr-8 text-left text-sm bg-card border border-slate-200 rounded-xl text-slate-900 placeholder-slate-400 shadow-[0_1px_2px_0_rgb(15_23_42/0.04)]',
