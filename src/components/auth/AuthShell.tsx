...
export function AuthShell({ title, subtitle, children }: AuthShellProps) {
  return (
    <div className="min-h-screen grid lg:grid-cols-[1.05fr_1fr] bg-card">
      {/* Brand panel */}
      <aside className="relative hidden lg:flex flex-col justify-between overflow-hidden bg-ink-950 p-12 text-white">
        ...
        <div className="relative max-w-md">
          ...
          <div className="relative mb-10">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-ink-400">Northwind Studio</div>
                  </div>
                </div>
            ...
            <div className="absolute -right-8 -bottom-12 flex items-center gap-2.5 rounded-xl bg-white text-ink-900 px-3.5 py-2.5 shadow-elevated animate-float">
              <div className="w-7 h-7 rounded-lg bg-emerald-500 flex items-center justify-center">
                <TrendingUp className="w-3.5 h-3.5 text-white" />
              </div>
              <div className="text-xs">
                <div className="font-semibold">Revenue up</div>
                <div className="text-ink-500">this quarter</div>
              </div>
            </div>
          </div>
          ...
          <ul className="mt-6 space-y-3">
            {[
              ...
              <li key={t} className="flex items-center gap-3 text-sm text-ink-300">
        ...
        <p className="relative text-xs text-ink-500">© {new Date().getFullYear()} InvoiceFlow</p>
      </aside>
