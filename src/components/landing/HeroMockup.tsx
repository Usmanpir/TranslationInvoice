...
export function HeroMockup() {
  ...
  return (
    <div className="relative mx-auto max-w-5xl" aria-hidden>
      ...
      {/* Browser frame */}
      <div className="relative rounded-[20px] p-1.5 bg-gradient-to-b from-white/80 to-white/30 ring-1 ring-slate-900/10 shadow-elevated backdrop-blur">
        <div className="rounded-2xl overflow-hidden bg-white ring-1 ring-slate-900/5">
          <div className="flex items-center gap-2 h-9 px-4 bg-slate-50 border-b border-slate-200/70">
            <span className="w-2.5 h-2.5 rounded-full bg-[#ff5f57]" />
            <span className="w-2.5 h-2.5 rounded-full bg-[#febc2e]" />
            <span className="w-2.5 h-2.5 rounded-full bg-[#28c840]" />
            <div className="mx-auto h-5 w-56 max-w-[45%] rounded-md bg-white border border-slate-200/80 text-[10px] text-slate-400 flex items-center justify-center font-mono whitespace-nowrap overflow-hidden px-2">
          ...
          <div className="flex min-h-[340px] sm:min-h-[400px]">
            {/* Mini sidebar */}
            <div className="hidden sm:flex w-44 flex-col gap-1 bg-slate-950 p-3">
              ...
              {[
                ...
                <div
                  key={l}
                  className={`flex items-center gap-2 px-2.5 py-2 rounded-lg text-[11px] font-medium ${a ? 'bg-white/10 text-white' : 'text-slate-400'}`}
                >
            ...
            <div className="flex-1 min-w-0 p-4 sm:p-5 bg-surface-50 space-y-4">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                {[
                  ...
                  <div key={l} className={`rounded-xl bg-white border border-slate-200/70 p-3 shadow-card ${i > 1 ? 'hidden lg:block' : ''}`}>
                    <div className="flex items-center justify-between">
              ...
              <div className="grid lg:grid-cols-5 gap-3">
                <div className="lg:col-span-3 rounded-xl bg-white border border-slate-200/70 shadow-card overflow-hidden">
                ...
                <div className="hidden lg:flex lg:col-span-2 flex-col rounded-xl bg-white border border-slate-200/70 shadow-card p-3.5">
      ...
      <div className="hidden md:flex absolute -left-8 lg:-left-14 top-[38%] items-center gap-3 p-3 pr-4 rounded-2xl bg-white/95 backdrop-blur ring-1 ring-slate-900/5 shadow-elevated animate-float">
      ...
      <div
        className="hidden md:flex absolute -right-6 lg:-right-12 bottom-10 items-center gap-3 p-3 pr-4 rounded-2xl bg-white/95 backdrop-blur ring-1 ring-slate-900/5 shadow-elevated animate-float"
