    ...
    <section className="relative pt-32 sm:pt-40 pb-20 sm:pb-28">
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 text-center">
        <div className="animate-fade-up">
          <span className="eyebrow bg-white text-slate-700 ring-1 ring-slate-900/10 shadow-card">
...
function SectionHeading({ eyebrow, title, desc, dark }: { eyebrow: string; title: React.ReactNode; desc: string; dark?: boolean }) {
  return (
    <Reveal className="mx-auto max-w-2xl text-center">
      <span className={`eyebrow ${dark ? 'bg-white/10 text-brand-200 ring-1 ring-white/15' : 'bg-brand-50 text-brand-700 ring-1 ring-brand-100'}`}>
        {eyebrow}
      </span>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-6 gap-4 sm:gap-5">
          ...
          <Reveal className="md:col-span-4">
            <FeatureCard
              ...
              className="h-full"
            >
              <div className="mt-6 rounded-xl border border-slate-200/80 bg-gradient-to-b from-slate-50 to-white p-4 sm:p-5">
                ...
                <div className="mt-2 flex items-center justify-between rounded-lg bg-slate-900 text-white px-3 py-2 text-sm font-semibold">
                  <span>Total</span>
          ...
          <Reveal className="md:col-span-3">
            ...
            >
              <div className="mt-6 flex items-center gap-2 text-xs">
                <span className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg border border-slate-200 bg-white text-slate-600">
            ...
            >
              <div className="mt-6 flex -space-x-2">
                {['from-brand-400 to-brand-600', 'from-violet-400 to-purple-600', 'from-emerald-400 to-teal-600', 'from-amber-400 to-orange-500'].map((g, i) => (
                  <div key={g} className={`w-8 h-8 rounded-full ring-2 ring-white bg-gradient-to-br ${g} flex items-center justify-center text-[11px] font-bold text-white`}>
                    {['A', 'M', 'S', 'R'][i]}
                  </div>
                ))}
                <div className="w-8 h-8 rounded-full ring-2 ring-white bg-slate-100 flex items-center justify-center text-[11px] font-semibold text-slate-500">+</div>
              </div>
            </FeatureCard>
          </Reveal>
        </div>
...
function FeatureCard({
  ...
  return (
    <div
      className={`group relative overflow-hidden rounded-3xl border border-slate-200/80 bg-white p-6 sm:p-7 shadow-card transition-all duration-300 hover:-translate-y-1 hover:shadow-card-hover hover:border-slate-300/80 ${className}`}
    >
...
function Details() {
  ...
  return (
    <section id="details" className="relative py-24 sm:py-32 bg-slate-950 text-white overflow-hidden scroll-mt-20">
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div>
            <Reveal>
              <span className="eyebrow bg-white/10 text-brand-200 ring-1 ring-white/15">Built for the details</span>
                ...
                {[
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-xs text-slate-400 truncate">{c.vat}</div>
                    </div>
                    <div className="font-display text-[15px] sm:text-lg font-bold tabular-nums whitespace-nowrap">{c.amt}</div>
                  </div>
                ))}
                <div className="flex items-center gap-2 pt-2 px-1 text-xs text-slate-400">
